<template>
  <div class="active-info-management kbjjknb">
    <div class="search">
      <div class="input">
        <el-input placeholder="请输入组织名称" clearable v-model="organizeName"></el-input>
        <el-button slot="append" icon="el-icon-search" @click="searchOrganize"></el-button>
      </div>
      <div class="search-list economics-user-tree-container">
        <el-tree
...
.active-info-management {
  ...
  .search {
    ...
    .search-list {
      margin: 0 @defaultPaddingX @defaultPaddingX;
      overflow: auto;
