<template>
  <div class="content_bg">
    <ul class="public_ul">
      <li class="public_list" @click="publicHandleClick">
        <div class="public_status">待定12</div>
        <h4>5岁幼童幼儿园去世，这些情况宝宝出现呕吐立即就医——舆情上报</h4>
        <el-row>
          <el-col :span="10"
            ><div class="t1">事故发生单位：巴城瑞斯顿幼儿园</div></el-col
          >
          <el-col :span="10"
            ><div class="t1">
              <span class="t2">地 点</span>：四川省巴中市巴城区
            </div></el-col
          >
        </el-row>
        <el-row>
          <el-col :span="10"
            ><div class="t1">发 病 时 间：11-21 10:34</div></el-col
          >
          <el-col :span="10"
            ><div class="t1">
              进 食 时 间：11-21 09:32
      ...
      <li class="public_list">
        <div class="public_status">待定</div>
        <h4>5岁幼童幼儿园去世，这些情况宝宝出现呕吐立即就医——舆情上报</h4>
        <el-row>
          <el-col :span="10"
            ><div class="t1">事故发生单位：巴城瑞斯顿幼儿园</div></el-col
