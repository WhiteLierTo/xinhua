<template>
	<view class="pending-content">
		...
		<!-- 内容 -->
			<view class="cont-items" v-for="(item, index) in overDue" :key="index">
				...
				<view class="btn"><button @click="openWarn(item.processId, item.operatorDeptId)">督办</button></view>
			</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		openWarn(pid, did) {
			uni.navigateTo({
				url: '/pages/warn/warn?type=2&pid=' + pid + '&did=' + did
			})
		}
	},
	onLoad() {
