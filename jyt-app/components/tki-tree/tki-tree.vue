					...
					<block v-for="(item, index) in treeList" :key="index">
						<view class="tki-tree-item" :style="[{
							...
							<view class="tki-tree-check" @tap.stop="_treeItemSelect(item, index)" v-if="selectParent?true:item.lastRank">
								...
								<view class="tki-tree-check-no" v-if="item.checked===false&&item.source.virtualFlag!=1" :class="{'radio':!multiple}" :style="{'border-color':confirmColor}"></view>
							</view>
						</view>
					</block>
				</scroll-view>
